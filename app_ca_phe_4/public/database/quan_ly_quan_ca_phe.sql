...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 29, 2018 at 05:55 AM
...
CREATE TABLE IF NOT EXISTS `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='Accounts';
...
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', '2018-04-02', 1, '111 tùng thiện vương quận 8', 'admin@gmail.com', '0135145', '0122365548', 1),
...
(3, 'thanh', 'e10adc3949ba59abbe56e057f20f883e', 'Đặng Thành', '2004-01-22', 1, '1/6 Mễ cốc quận 8', '', '', '', 0);
...
CREATE TABLE IF NOT EXISTS `chi_tiet_hoa_don` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=314 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Chi tiết hóa đơn';
...
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Hóa đơn';
...
(66, '2018-04-29', '49', 'Bàn 1', 0, 177000, '');
